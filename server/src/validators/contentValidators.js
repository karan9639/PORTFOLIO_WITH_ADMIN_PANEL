...
const pairArray = z.array(z.object({ label: z.string(), value: z.string() })).optional().default([]);
...
export const serviceSchema = z.object({ title: requiredText('Title'), description: requiredText('Description'), icon: optionalText, deliverables: csv, sortOrder: numberField });
...
export const projectSchema = z.object({ title: requiredText('Title'), slug: optionalText, excerpt: requiredText('Excerpt'), description: requiredText('Description'), imageUrl: optionalUrl, technologies: csv, githubUrl: optionalUrl, liveUrl: optionalUrl, caseStudyUrl: optionalUrl, role: optionalText, year: optionalText, duration: optionalText, projectType: optionalText, status: optionalText, featured: z.coerce.boolean().optional().default(false), highlights: csv, sortOrder: numberField });
export const experienceSchema = z.object({ company: requiredText('Company'), role: requiredText('Role'), location: optionalText, period: requiredText('Period'), employmentType: optionalText, stack: csv, current: z.coerce.boolean().optional().default(false), description: requiredText('Description'), highlights: csv, sortOrder: numberField });
...
export const certificationSchema = z.object({ title: requiredText('Title'), issuer: requiredText('Issuer'), issuedAt: optionalText, credentialId: optionalText, credentialUrl: optionalUrl, skillsCovered: csv, description: optionalText, sortOrder: numberField });
